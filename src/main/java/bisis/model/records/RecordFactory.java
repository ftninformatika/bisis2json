package bisis.model.records;

import bisis.model.records.serializers.FullFormatSerializer;
import bisis.model.records.serializers.IsisSerializer;
import bisis.model.records.serializers.LooseXMLSerializer;
import bisis.model.records.serializers.TightXMLSerializer;
import bisis.model.records.serializers.UnimarcSerializer;
...
public class RecordFactory {
 ...
 /* public static String toUNIMARC(int pubType, Record rec) {
  ...
  public static String toUNIMARC(int pubType, Record rec) {
    return UnimarcSerializer.toUNIMARC(pubType, 
        rec.primerciUPolja().polje000UMetapodatke(), true);
  }
