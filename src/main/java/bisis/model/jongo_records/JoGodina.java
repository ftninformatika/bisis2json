...
public class JoGodina implements Serializable {
    ...
    private List<JoSveska> sveske;

    public JoGodina() {
        sveske = new ArrayList<JoSveska>();
    }

    public JoGodina(Godina g) {
        this();
  ...
  /*public Godina(int godinaID, String invBroj, Date datumRacuna,
    ...
    public void add(JoSveska s) {
        sveske.add(s);
    }

    public JoSveska getSveska(int index) {
    ...
    public Iterator<JoSveska> sveskeIterator() {
    ...
    public List<JoSveska> getSveske() {
        return sveske;
    }

    public void setSveske(List<JoSveska> sveske) {
        this.sveske = sveske;
    }
    ...
    public JoSveska getSveska(String invBroj){
        for(JoSveska s:sveske){
    ...
    public JoGodina copy(){
        JoGodina godRet = new JoGodina();
