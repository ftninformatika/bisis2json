...
public class JoRecord implements Serializable {
     ...
     */
    public bisis.model.records.Record shallowCopy(){
        bisis.model.records.Record rec = new bisis.model.records.Record();
     ...
     */
    public bisis.model.records.Record copyWithoutHoldings(){
        bisis.model.records.Record rec = new bisis.model.records.Record();
        rec.setPubType(pubType);
        rec.setCreator(creator);
        rec.setModifier(modifier);
