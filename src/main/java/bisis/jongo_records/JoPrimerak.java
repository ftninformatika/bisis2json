...
public class JoPrimerak implements Serializable {
    ...
    public JoPrimerak(Primerak primerak) {
    ...
    public JoPrimerak(int primerakID, String invBroj, Date datumRacuna,
    ...
    public JoPrimerak copy() {
        return new JoPrimerak(getPrimerakID(), getInvBroj(), getDatumRacuna(),
