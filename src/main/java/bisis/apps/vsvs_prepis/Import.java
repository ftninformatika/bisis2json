package bisis.apps.vsvs_prepis;
...
public class Import {
    ...
    public static final String library = "vsvs";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            codersMap.put(bisis.apps.vsvs_prepis.Coders.CODER_TYPE_ACCESSION_REG, exportDir + "/invBooks.json");
            codersMap.put(bisis.apps.vsvs_prepis.Coders.CODER_TYPE_LOCATION, exportDir + "/locations.json");
    ...
    public static void printHelp(Options options){
        System.out.println("\n\nTool for migrating VSVS data to BISIS");
