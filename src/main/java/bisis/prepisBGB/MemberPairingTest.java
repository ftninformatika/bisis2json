...
public class MemberPairingTest {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/" + "bisis_zvezdara_final" + "?useSSL=false&serverTimezone=CET"
                    , "bisis", "bisis");
            ...
            System.out.println("Pairing members:");
...
//                System.out.println("Nasao ih: " + found + "\nNije nasao: " + nFound + "\nOd: " + total);
                if (centralMember != null && isSameMember2(localMember, centralMember)) {
    ...
    private static boolean isSameMember2(Member m, JoMember m2) {
